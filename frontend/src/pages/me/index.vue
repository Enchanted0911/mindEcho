  ...
  <view class="me-page">
    ...
    <scroll-view class="me-scroll" scroll-y>
      ...
      <view class="section">
        ...
        <view class="astro-entry-card" @click="uni.switchTab({ url: '/pages/astrology/index' })">
          <view class="astro-entry-glow" />
          <view class="astro-entry-left">
            <view class="astro-entry-icons">
              <text class="astro-icon-main">✦</text>
            </view>
            <view class="astro-entry-text">
              <text class="astro-entry-title">星屿占星</text>
              <text class="astro-entry-sub">本命盘 · 和盘 · 流运 · AI 解读</text>
            </view>
          </view>
          <text class="astro-entry-arrow">›</text>
        </view>
        <view class="astro-quick-row">
          <view class="astro-quick-btn" @click="uni.navigateTo({ url: '/pages/astrology/natal' })">
            <text class="aqb-icon">☉</text>
            <text class="aqb-label">本命盘</text>
          </view>
          <view class="astro-quick-btn" @click="uni.navigateTo({ url: '/pages/astrology/synastry' })">
            <text class="aqb-icon">∞</text>
            <text class="aqb-label">和盘</text>
          </view>
          <view class="astro-quick-btn" @click="uni.navigateTo({ url: '/pages/astrology/transit' })">
            <text class="aqb-icon">♄</text>
            <text class="aqb-label">流运</text>
          </view>
        </view>
      </view>
...
.astro-entry-card {
  position: relative;
  background: linear-gradient(135deg, rgba(139,111,209,0.1) 0%, rgba(80,50,140,0.06) 100%);
  border: 1rpx solid rgba(184,158,232,0.2);
  border-radius: 20rpx;
  padding: 24rpx 28rpx;
  display: flex;
...
.astro-entry-left { display: flex; align-items: center; gap: 20rpx; }
.astro-entry-icons {
...
.astro-icon-main { font-size: 36rpx; color: #c4a8f0; }
.astro-entry-text { display: flex; flex-direction: column; gap: 6rpx; }
.astro-entry-title { font-size: 32rpx; color: #e8d5ff; font-weight: 600; }
.astro-entry-sub { font-size: 22rpx; color: #7a6a9a; }
.astro-entry-arrow { font-size: 40rpx; color: #5a5070; }
...
.aqb-icon { font-size: 32rpx; color: #b89ee8; }
.aqb-label { font-size: 22rpx; color: #7a6a9a; }
</style>
